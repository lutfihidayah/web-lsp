...
<div class="mb-5">
    <a href="{{ route('admin.asesmen') }}" class="flex items-center gap-2 text-sm text-gray-500 hover:text-[#1e3a6e] transition">
...
<div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <form action="{{ route('admin.asesmen.konfirmasi-semua', $asesmen->id) }}" method="POST">
            @csrf
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-3">
                        ...
                        <form action="{{ route('admin.asesmen.konfirmasi', $abs->id) }}" method="POST" class="inline">
                            @csrf
