...
<aside class="w-64 min-h-screen bg-[#1e3a6e] text-white flex flex-col fixed left-0 top-0">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        <a href="{{ route('admin.asesmen') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
            {{ request()->routeIs('admin.asesmen*') ? 'bg-white text-[#1e3a6e]' : 'text-blue-100 hover:bg-blue-800' }}">
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('admin.users') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
            {{ request()->routeIs('admin.users*') ? 'bg-white text-[#1e3a6e]' : 'text-blue-100 hover:bg-blue-800' }}">
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
