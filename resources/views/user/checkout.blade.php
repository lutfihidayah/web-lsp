...
{{-- BACK BUTTON --}}
<div class="mb-5">
    <a href="{{ route('user.skema.show', $skema->id) }}" class="flex items-center gap-2 text-sm text-gray-500 hover:text-[#1e3a6e] transition">
    ...
    <div class="space-y-5">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-24">
            ...
            <div class="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-xl">
                ...
                <form action="{{ route('user.pembayaran.simulate', $pendingOrder->id) }}" method="POST">
                    @csrf
                    <button type="submit"
    ...
    document.getElementById('pay-button').addEventListener('click', function () {
        ...
        snap.pay('{{ $snapToken }}', {
            onSuccess: function (result) {
                window.location.href = '{{ route('user.pembayaran.callback') }}?order_id=' + result.order_id + '&status_code=200&transaction_status=settlement';
            },
