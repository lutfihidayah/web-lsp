...
<div class="mb-5">
    <a href="{{ route('user.asesmen.show', $asesmen->id) }}" class="flex items-center gap-2 text-sm text-gray-500 hover:text-[#1e3a6e] transition">
...
<form action="{{ route('user.asesmen.quiz.submit', $asesmen->id) }}" method="POST" id="quizForm">
    @csrf
