...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('users.index') }}" class="flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#1e3a6e] transition">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-5">
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('users.index') }}" class="px-6 py-2.5 border border-gray-200 text-gray-600 text-sm font-medium rounded-lg hover:bg-gray-50 transition">
                    Batal
                </a>
            </div>
        </form>
